...
// Split returns the 'host', 'id', 'query', and 'fragment' of at XRPC-URI or XRPC-unencrypted-URI..
//
// An 'id' should be an NSID (Namespaced Identifier).
//
// For example:
//
//	var uri string = "xrpc://public.api.bsky.app/app.bsky.actor.getProfile?actor=reiver.bsky.social"
//
//	host, id, query, fragment, err := xrpcuri_internal.Split(uri, "xrpc")
//	if nil != err {
//		return err
//	}
//
