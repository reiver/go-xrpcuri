	...
	}{
		{
			...
			ExpectedError: "xrpcuri: empty uri",
...

                {
                        ...
                        ExpectedError: `xrpcuri: XRPC-URI "xrpc://foo.com/example/123" has an id "example" that is not a valid NSID: nsid: nsid ("example") should have at least 3 segments but actually has 1`,
                },
